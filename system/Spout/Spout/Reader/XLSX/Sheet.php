...
class Sheet implements SheetInterface
{
     ...
     */
    public function __construct($filePath, $sheetDataXMLFilePath, $sharedStringsHelper, $sheetIndex, $sheetName, $startRowFromSheet)
    {
        $this->rowIterator = new RowIterator($filePath, $sheetDataXMLFilePath, $sharedStringsHelper, $startRowFromSheet);
