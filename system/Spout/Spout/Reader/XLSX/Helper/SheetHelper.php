...
class SheetHelper
{
     ...
     */
    public function __construct($filePath, $sharedStringsHelper, $globalFunctionsHelper, $rows)
    {
        $this->filePath = $filePath;
        $this->sharedStringsHelper = $sharedStringsHelper;
        $this->globalFunctionsHelper = $globalFunctionsHelper;
		$this->startRowFromSheet = $rows;
    }
    ...
    protected function getSheetFromXML($sheetDataXMLFilePath)
    {
        ...
        return new Sheet($this->filePath, $sheetDataXMLFilePath, $this->sharedStringsHelper, $sheetIndexZeroBased, $sheetName, $this->startRowFromSheet);
    }
