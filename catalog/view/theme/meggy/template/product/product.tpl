    ...
    <div id="content" class="<?php echo $class; ?> content_product "><?php echo $content_top; ?>
      <div class="row">
        ...
        <div id="xs_product" class="<?php echo $class; ?>">
          ...
          <?php } ?>
          <?php if ($thumb) { ?>
          <li class="tovar_img"><img class="tovar_img_img cloudzoom" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" data-cloudzoom="zoomWidth" alt="<?php echo $heading_title; ?>" />
