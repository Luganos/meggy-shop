<div id="cart" class="">
  <button id="tr" type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="button_smaoll_cart dropdown-toggle"><i ><img src="catalog/view/theme/meggy/image/noun.png" alt=""></i><div class="number_of_purchases"><span >0</span></div> <span id="cart-total"><?php echo $text_items; ?></span></button>
